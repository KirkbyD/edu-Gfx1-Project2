...
Keyboard:
	...
	Model Only
		R		Rotate negatively around Y
		T		Rotate positively around Y
		F		Rotate negatively around X
		G		Rotate positively around X
		V		Rotate negatively around Z
		B		Rotate positively around Z
